...
import { parse835, eraStatusToClaimStatus, summarizeAdjustments, } from '../services/edi-835.js';
...
describe('parse835', () => {
    ...
    it('summarizes adjustments into a reason string', () => {
        expect(summarizeAdjustments([{ group: 'CO', reasonCode: '45', amountCents: 5000 }])).toBe('CO/45: $50.00');
        expect(summarizeAdjustments([])).toBeNull();
    });
});
//# sourceMappingURL=edi-835.test.js.map