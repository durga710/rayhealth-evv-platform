...
function deriveStatus(statusCode, chargeCents, paidCents) {
    if (statusCode === '22')
        return 'reversed';
    if (statusCode === '4')
        return 'denied';
...
export function parse835(text) {
    ...
    if (!trimmed)
        throw new Error('Empty remittance file');
...
export function eraStatusToClaimStatus(s) {
    if (s === 'denied')
        return 'denied';
    if (s === 'reversed')
        return 'rejected';
...
//# sourceMappingURL=edi-835.js.map