...
export declare function submitVisits(config: HhaexchangeClientConfig, _visits: VisitSubmission[]): Promise<AggregatorSubmitResult>;
//# sourceMappingURL=hhaexchange-client.d.ts.map