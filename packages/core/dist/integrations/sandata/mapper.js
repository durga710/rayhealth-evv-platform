 ...
 */
import { SandataCallType, } from './types.js';
/** 'YYYY-MM-DD' (or any ISO date) → 'CCYYMMDD'. Returns undefined for empty. */
export function toCCYYMMDD(isoDate) {
    if (!isoDate)
        return undefined;
 ...
 */
export function mapClient(client, sequenceId) {
    const address = client.addressLine1
        ? {
 ...
 * on visits.
 */
export function mapEmployee(caregiver, sequenceId) {
 ...
 */
export function mapVisit(visit, sequenceId, opts = {}) {
