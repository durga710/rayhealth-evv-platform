    ...
    >
      ...
      <form style={card} onSubmit={onSave}>
        ...
        <div style={{ ...fieldRow, borderTop: '1px solid var(--color-border, var(--color-border))', paddingTop: '1rem' }}>
          <label style={label}>Issued integration credentials {config?.hasCredentials && <span style={{ color: 'var(--color-success, var(--color-success-text))', fontWeight: 600 }}>· stored</span>}</label>
