...
describe('GET /auth/mobile/me', () => {
    it('returns firstName/lastName from caregivers row when role=caregiver', async () => {
        ...
        vi.spyOn(core, 'UserRepository').mockImplementation(() => ({ findById }));
        vi.spyOn(core, 'CaregiverRepository').mockImplementation(() => ({ findById: caregiverFindById }));
...
//# sourceMappingURL=auth-mobile-me.test.js.map