...
describe('auth signup route', () => {
    function mockSignupRepos() {
        ...
        app.set('db', { transaction: async (cb) => cb({}) });
    ...
    it('records an agency.review.requested audit event on signup', async () => {
        ...
        expect(createAuditEvent).toHaveBeenCalledWith(expect.objectContaining({ eventType: 'agency.review.requested', outcome: 'success' }));
    });
});
//# sourceMappingURL=auth-signup-routes.test.js.map