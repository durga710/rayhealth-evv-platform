...
function mockTaskRepository(overrides = {}) {
    ...
    vi.spyOn(core, 'VisitTaskCompletionRepository').mockImplementation(() => ({ getForVisit, upsertBatch, ...overrides }));
...
//# sourceMappingURL=visit-task-routes.test.js.map