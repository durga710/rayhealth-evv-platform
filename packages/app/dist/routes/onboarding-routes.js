...
const FIRST_QUESTION_FALLBACK = "Hi! Thanks for applying. Let's get started — tell me a bit about yourself and your background in caregiving or direct support work.";
...
router.get('/interview/:token', async (req, res) => {
    try {
        ...
        if (interview.messages.length === 0 && interview.status === 'pending') {
            ...
            const firstMessage = { role: 'assistant', content: greeting };
