...
import { askGemini, isGeminiConfigured, } from './services/gemini-client.js';
...
export const aiModel = bedrock(BEDROCK_MODEL_ID);
/**
...
export class AINotConfiguredError extends Error {
    constructor() {
        super('No AI provider configured (set AWS_BEARER_TOKEN_BEDROCK or GOOGLE_AI_API_KEY).');
...
export async function askAI(input) {
    ...
    if (isBedrockConfigured()) {
        const modelId = input.tier === 'pro' && process.env.BEDROCK_MODEL_ID_PRO
